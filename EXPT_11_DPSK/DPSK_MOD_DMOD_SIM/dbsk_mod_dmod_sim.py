...
# Title: DBPSK Modulation Demodulation
# Author: AKADEMIKA Lab Solution
# Generated: Wed Jul 24 11:23:44 2019
##################################################
...
class dbsk_mod_dmod_sim(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="DBPSK Modulation Demodulation")
...
def main(top_block_cls=dbsk_mod_dmod_sim, options=None):
