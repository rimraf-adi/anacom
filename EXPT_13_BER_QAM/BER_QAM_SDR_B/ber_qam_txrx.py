...
# Title: BER of QAM Transmitter and Receiver
# Author: AKADEMIKA Lab Solution
# Generated: Mon Jul 22 11:21:09 2019
##################################################
...
class ber_qam_txrx(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="BER of QAM Transmitter and Receiver")
        ...
        self.notebook_0.AddPage(grc_wxgui.Panel(self.notebook_0), "Transmitted Stream of Bits")
        self.notebook_0.AddPage(grc_wxgui.Panel(self.notebook_0), "Constellation of Transmitted Stream of Bits")
        self.notebook_0.AddPage(grc_wxgui.Panel(self.notebook_0), "Received Bits of Stream")
        ...
        self.notebook_0.GetPage(1).GridAdd(self.wxgui_scopesink2_0.win, 2, 0, 1, 1)
        ...
        self.blocks_short_to_char_1 = blocks.short_to_char(1)
        ...
        self.connect((self.analog_random_source_x_0, 0), (self.blocks_short_to_char_1, 0))
        ...
        self.connect((self.blocks_short_to_char_1, 0), (self.blks2_error_rate_0, 0))
...
def main(top_block_cls=ber_qam_txrx, options=None):
