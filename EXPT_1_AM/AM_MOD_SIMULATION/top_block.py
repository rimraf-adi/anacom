...
# Title: AM Modulation Simulation
# Author: AKADEMIKA Lab Solution
# Generated: Wed Mar  1 23:48:29 2023
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="AM Modulation Simulation")
        ...
        self.wxgui_scopesink2_0 = scopesink2.scope_sink_f(
        	self.GetWin(),
        	title='AM_modulated Scope representation',
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 10e3, 1, 0)
