...
# Generated: Wed Jul 24 10:43:17 2019
##################################################
...
class fm_simple_mod_dmod(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.wxgui_scopesink2_0 = scopesink2.scope_sink_f(
        	self.GetWin(),
        	title='Scope representation of Demodulated Signal',
        ...
        self.wxgui_fftsink2_0 = fftsink2.fft_sink_f(
        	...
        	average=False,
        	avg_alpha=None,
        	title='Spectral representation of Demodulated Signal',
        	peak_hold=False,
        )
        self.Add(self.wxgui_fftsink2_0.win)
        self.blocks_throttle_0_0_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.analog_sig_source_x_0_1 = analog.sig_source_f(300000, analog.GR_SIN_WAVE, 10000, amplitude, 0)
        ...
        self.connect((self.analog_sig_source_x_0_1, 0), (self.analog_frequency_modulator_fc_0_0, 0))
    ...
    def set_amplitude(self, amplitude):
        ...
        self.analog_sig_source_x_0_1.set_amplitude(self.amplitude)
