...
# Generated: Wed Jul 24 11:30:13 2019
##################################################
...
class gmsk_mod_sim(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="GMSK Modulation")
        ...
        self.notebook_0.AddPage(grc_wxgui.Panel(self.notebook_0), "Spectrum of Modulated Signal")
        ...
        self.notebook_0.GetPage(0).Add(self.wxgui_scopesink2_0_0_0.win)
        self.wxgui_scopesink2_0 = scopesink2.scope_sink_c(
        	self.notebook_0.GetPage(1).GetWin(),
        	title='Scope of Modulated Dignal',
        	sample_rate=samp_rate,
        	v_scale=0,
        	v_offset=0,
        	t_scale=0,
        ...
        self.connect((self.blocks_char_to_float_0, 0), (self.wxgui_scopesink2_0_0_0, 0))
...
def main(top_block_cls=gmsk_mod_sim, options=None):
