...
# Generated: Tue Aug 25 16:10:48 2015
##################################################
...
class bpsk_mod_dmod_sim(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="BPSK Demodulation")
