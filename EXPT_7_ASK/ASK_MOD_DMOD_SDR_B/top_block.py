...
# Generated: Mon Apr  3 23:12:05 2023
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.wxgui_scopesink2_0 = scopesink2.scope_sink_f(
        	self.GetWin(),
        	title='Scope Representation of Received Signal ',
        ...
        self.wxgui_fftsink2_0_0 = fftsink2.fft_sink_f(
        	...
        	average=False,
        	avg_alpha=None,
        	title='Specrtrum of Received Signal',
        	peak_hold=False,
        )
        ...
        self.blocks_threshold_ff_0 = blocks.threshold_ff(0.1, 0.3, 0)
