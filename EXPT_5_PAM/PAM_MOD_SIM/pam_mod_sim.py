...
# Generated: Fri Feb 19 11:28:20 2016
##################################################
...
class pam_mod_sim(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="PAM Modulation ")
...
def main(top_block_cls=pam_mod_sim, options=None):
