...
# Title: DSSS Modulation
# Author: AKADEMIKA Lab Solution
# Generated: Wed Jul 24 11:28:13 2019
##################################################
...
class dsss_mod_sim(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="DSSS Modulation")
        ...
        self.notebook_0.AddPage(grc_wxgui.Panel(self.notebook_0), "DSSS Signal")
        self.notebook_0.AddPage(grc_wxgui.Panel(self.notebook_0), "Spectrum of DSSS Signal")
...
def main(top_block_cls=dsss_mod_sim, options=None):
