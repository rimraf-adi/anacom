...
# Title: OFDM Modulation Demodulation Simulation
# Author: AKADEMIKA Lab Solution
# Generated: Wed Jul 24 11:27:19 2019
##################################################
...
class ofdm_mod_dmod_sim(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="OFDM Modulation Demodulation Simulation")
        ...
        self.connect((self.blocks_throttle_1, 0), (self.digital_ofdm_demod_0, 0))
        ...
        self.connect((self.blocks_throttle_1_0, 0), (self.wxgui_scopesink2_0, 0))
        self.connect((self.digital_ofdm_demod_0, 0), (self.blocks_throttle_1_0, 0))
...
def main(top_block_cls=ofdm_mod_dmod_sim, options=None):
