...
# Title: BER oF QPSK Transmitter and Receiver
# Author: Akademika Lab Solution
# Generated: Mon Jul 22 12:03:56 2019
##################################################
...
class QPSK_BER(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="BER oF QPSK Transmitter and Receiver")
        ...
        self.notebook_0.AddPage(grc_wxgui.Panel(self.notebook_0), "QPSK Constellation Plot")
...
def main(top_block_cls=QPSK_BER, options=None):
