...
# Title: BER of 16-PSK Transmitter and Receiver.
# Author: Akademika Lab Solution
# Generated: Mon Jul 22 11:55:35 2019
##################################################
...
class SixteenPSK_BER(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="BER of 16-PSK Transmitter and Receiver.")
        ...
        self.notebook_0.AddPage(grc_wxgui.Panel(self.notebook_0), "16PSK Constellation Plot")
        ...
        self.wxgui_constellationsink2_0 = constsink_gl.const_sink_c(
        	...
        	title='16PSK Constellation Plot',
        	sample_rate=samp_rate,
        	frame_rate=5,
        	const_size=2048,
        	M=4,
...
def main(top_block_cls=SixteenPSK_BER, options=None):
