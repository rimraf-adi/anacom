...
# Title: BER oF 8PSK Transmitter and Receiver.
# Author: Akademika Lab Solution
# Generated: Mon Jul 22 11:53:23 2019
##################################################
...
class EightPSK_BER(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="BER oF 8PSK Transmitter and Receiver.")
        ...
        self.notebook_0.AddPage(grc_wxgui.Panel(self.notebook_0), "8PSK Constellation Plot")
...
def main(top_block_cls=EightPSK_BER, options=None):
