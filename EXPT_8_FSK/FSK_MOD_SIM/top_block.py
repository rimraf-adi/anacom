...
# Generated: Wed Jul 24 11:17:03 2019
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="FSK Modulation")
        ...
        self.delay = blocks.add_const_vff((ampli, ))
        ...
        self.connect((self.blocks_throttle_0, 0), (self.mixer_0, 0))
        self.connect((self.blocks_throttle_0_0, 0), (self.mixer, 1))
        self.connect((self.blocks_throttle_0_1, 0), (self.invert, 0))
        self.connect((self.blocks_throttle_0_1, 0), (self.mixer_0, 1))
